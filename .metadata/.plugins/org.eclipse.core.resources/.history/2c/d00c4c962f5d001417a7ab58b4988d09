...
public class Markets extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Markets", "before getMarkets");
        Cursor c=db.getMarkets();
        @SuppressWarnings("deprecation")
		ListAdapter adapter=new SimpleCursorAdapter(this, R.layout.activity_markets, c, new String[]{"Name", "address"}, new int[]{R.id.marketname, R.id.address});
